...
<body style="margin:0;padding:0;background:${BG};font-family:Cairo,'Segoe UI',Tahoma,Arial,sans-serif;">
  <div style="max-width:560px;margin:30px auto;background:${CARD_BG};border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(61,139,110,0.12);">
    <div style="background:linear-gradient(135deg,${PRIMARY},${PRIMARY_DARK});padding:36px 24px;text-align:center;">
      ...
      <p style="margin:8px 0 0;color:rgba(255,255,255,0.8);font-size:14px;">تم قبول إعلانك! 🎉</p>
    </div>
    <div style="padding:28px 24px;text-align:center;">
      ...
      <h2 style="margin:0 0 8px;color:${TEXT_DARK};font-size:21px;font-weight:800;">مبروك! تم قبول إعلانك</h2>
      <p style="color:${TEXT_MUTED};font-size:14px;margin:0 0 24px;">إعلانك الآن نشط ويظهر للمستخدمين في التطبيق</p>
      ...
      <div style="margin-top:24px;padding:14px 18px;background:rgba(201,149,43,0.08);border-radius:12px;border:1px solid rgba(201,149,43,0.15);">
        <p style="color:${GOLD};font-size:13px;font-weight:700;margin:0;">⭐ إعلانك الآن نشط ومتاح لجميع المستخدمين</p>
      </div>
      ...
      <div style="margin-top:24px;padding-top:16px;border-top:1px solid rgba(61,139,110,0.08);">
        ...
        <p style="color:${TEXT_LIGHT};font-size:10px;margin:4px 0 0;">شكراً لثقتك بنا</p>
      </div>
    </div>
  </div>
</body>
    ...
    await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [customerEmail],
        subject: `تم قبول إعلانك #${orderNumber} - لمحة للتسويق 🎉`,
        html,
      }),
    });
